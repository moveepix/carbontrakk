...
class _VehicleListWidgetState extends State<VehicleListWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.vehicleList = await EmissionTable().queryRows(
        queryFn: (q) => q
            .eq(
              'user_id',
              currentUserUid,
            ...
            children: [
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Builder(
                    builder: (context) {
                      final vehicleTable = _model.vehicleemissionlist.toList();
                      if (vehicleTable.isEmpty) {
                        return Center(
                      ...
                      return FlutterFlowDataTable<EmissionRow>(
                        ...
                        dataRowBuilder: (vehicleTableItem, vehicleTableIndex,
                                selected, onSelectChanged) =>
                            DataRow(
                          color: MaterialStateProperty.all(
                            vehicleTableIndex % 2 == 0
                                ? FlutterFlowTheme.of(context)
                                    .secondaryBackground
                                : FlutterFlowTheme.of(context)
                                    .primaryBackground,
                          ...
                          cells: [
                            ...
                            Text(
                              vehicleTableItem.consumption.toString(),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    fontFamily: FlutterFlowTheme.of(context)
                            ...
                            Text(
                              vehicleTableItem.emissionValue.toString(),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    fontFamily: FlutterFlowTheme.of(context)
