...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF8BC34A);
  ...
  late Color accent1 = const Color(0xFFFF5722);
  late Color accent2 = const Color(0xFFFFC107);
  late Color accent3 = const Color(0xFF03A9F4);
  late Color accent4 = const Color(0xFF673AB7);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF689F38);
  ...
  late Color accent1 = const Color(0xFFE64A19);
  late Color accent2 = const Color(0xFFFFA000);
  late Color accent3 = const Color(0xFF0288D1);
  late Color accent4 = const Color(0xFF512DA8);
