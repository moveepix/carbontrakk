...
import 'add_electricity_consumption_model.dart';
export 'add_electricity_consumption_model.dart';

class AddElectricityConsumptionWidget extends StatefulWidget {
  const AddElectricityConsumptionWidget({super.key});

  @override
  State<AddElectricityConsumptionWidget> createState() =>
      _AddElectricityConsumptionWidgetState();
}

class _AddElectricityConsumptionWidgetState
    extends State<AddElectricityConsumptionWidget> {
  late AddElectricityConsumptionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddElectricityConsumptionModel());
                          ...
                          children: [
                              ...
                              children: [
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 8.0, 0.0, 0.0),
                                  child: Text(
                                    'Create a label/name for your electricity usage',
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: 'Electricity usage name',
                                  ...
                                  validator: _model
                                      .activityTextControllerValidator
                                      .asValidator(context),
                                ),
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 8.0, 0.0, 0.0),
                                  child: Text(
                                    'Select the electrical grid that supply power to your business',
                                    style: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                          fontFamily:
                                ...
                                FutureBuilder<List<EmissionFactorRow>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return FlutterFlowDropDown<double>(
                                      ...
                                      hintText: 'Select Electricity Grid',
                                      icon: Icon(
                                ...
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 8.0, 0.0, 0.0),
                                  child: Text(
                                    'For which year is this electricity usage data?',
                                    style: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                          fontFamily:
                                ...
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 8.0, 0.0, 0.0),
                                  child: Text(
                                    'For which month is this electricity usage data?',
                                    style: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                          fontFamily:
                                ...
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 8.0, 0.0, 0.0),
                                  child: Text(
                                    'Average electricity usage that month',
                                    style: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                          fontFamily:
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: !((_model.activityTextController
                                                    .text !=
                                                '') &&
                                        (_model.consumptionTextController
                                                    .text !=
                                    ...
                                    : () async {
                                        ...
                                        context.goNamed('ElectricityList');
                                      },
                                text: 'Save Data',
