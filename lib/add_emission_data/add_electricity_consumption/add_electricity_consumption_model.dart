...
import 'add_electricity_consumption_widget.dart'
    show AddElectricityConsumptionWidget;
import 'package:flutter/material.dart';

class AddElectricityConsumptionModel
    extends FlutterFlowModel<AddElectricityConsumptionWidget> {
  ...
  // Stores action output result for [Custom Action - emissionCalculation] action in Consumption widget.
  double? emission;
