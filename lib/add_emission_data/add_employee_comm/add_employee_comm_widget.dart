...
import 'add_employee_comm_model.dart';
export 'add_employee_comm_model.dart';

class AddEmployeeCommWidget extends StatefulWidget {
  const AddEmployeeCommWidget({super.key});

  @override
  State<AddEmployeeCommWidget> createState() => _AddEmployeeCommWidgetState();
}

class _AddEmployeeCommWidgetState extends State<AddEmployeeCommWidget> {
  late AddEmployeeCommModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddEmployeeCommModel());
                          ...
                          children: [
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                labelText: 'Commuting Activity Name',
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: FlutterFlowCountController(
                                      ...
                                      count: _model.totalemployeeValue ??= 1,
                                      updateCount: (count) => setState(() =>
                                          _model.totalemployeeValue = count),
                                      stepSize: 1,
                                      minimum: 1,
                                      maximum: 200,
                                    ),
                                ...
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 8.0, 8.0, 8.0),
                                  child: Text(
                                    _model.dropDownEFValue!.toString(),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyLarge
                                        .override(
                                          fontFamily:
                                    ...
                                    onChanged: (_) => EasyDebounce.debounce(
                                      ...
                                      () async {
                                        ...
                                        _model.emission = await actions
                                          ...
                                          _model.dropDownEFValue!.toDouble(),
                                          double.parse(_model
                                              .consumptionTextController.text),
                                          _model.totalemployeeValue!,
                                        );
